...
echo "tar cfvz $TMP/$DATE/centreon-$DATE_HEURE.tgz $PLUGINS/ /usr/local/centreon/www/img/media/ /var/lib/centreon/ /etc/centreon/ dump-mysql-$NOMBRE_ALEATOIRE/ plateforme/ -P" >> $REPERTOIRE_SCRIPTS/$FICHIER_SCRIPTS_CENTREON_FTP
...
echo "mkdir $REF52/`uname -n`/MySQL/$PURGE" >> $REPERTOIRE_SCRIPTS/$FICHIER_PURGE_CENTREON_FTP
echo "cd $REF52/`uname -n`/MySQL/$PURGE" >> $REPERTOIRE_SCRIPTS/$FICHIER_PURGE_CENTREON_FTP
echo "mdelete *.*" >> $REPERTOIRE_SCRIPTS/$FICHIER_PURGE_CENTREON_FTP
echo "cd /" >> $REPERTOIRE_SCRIPTS/$FICHIER_PURGE_CENTREON_FTP
echo "rmdir $REF52/`uname -n`/MySQL/$PURGE" >> $REPERTOIRE_SCRIPTS/$FICHIER_PURGE_CENTREON_FTP
done
